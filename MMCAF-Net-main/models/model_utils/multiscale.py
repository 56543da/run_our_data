...
if __name__ == "__main__":
    ...
    mscb3 = DCFB(in_channels=256, out_channels=256, stride=1, kernel_sizes=[1, 3, 5], expansion_factor=2,
                              dw_parallel=True, add=True, activation='relu6')
    out3=mscb3(out2)
    eucb_ks = 3  # kernel size for eucb
    eucb2 = UCB(in_channels=256, out_channels=256, kernel_size=eucb_ks, stride=eucb_ks // 2)
    out4=eucb2(out3)
